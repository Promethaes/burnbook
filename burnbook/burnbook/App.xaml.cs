...
using burnbook.Notifications;
using burnbook.Services;
using burnbook.ViewModels;
using burnbook.Views;
...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddSingleton<IFocusButtonService, FocusButtonService>();
            ...
            services.AddTransient<FocusButtonViewModel>();
            services.AddTransient<FocusButtonPage>();
